...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--ns_tokenizer_type', type=str, default='rankmixer',
                        ...
                        help='NS tokenizer variant: '
                             ...
                             'auto = data-driven feature grouping via learnable Top-k')
    parser.add_argument('--user_ns_tokens', type=int, default=0,
                        help='Number of user NS tokens in rankmixer/auto mode '
                             '(0 = automatically use the number of user groups)')
    parser.add_argument('--item_ns_tokens', type=int, default=0,
                        help='Number of item NS tokens in rankmixer/auto mode '
                             '(0 = automatically use the number of item groups)')

    # AutoToken parameters (only used when --ns_tokenizer_type=auto)
    parser.add_argument('--auto_top_k', type=int, default=10,
                        help='Number of features selected per token in auto mode. '
                             '0 = automatically ceil(n_f / num_ns_tokens).')
    parser.add_argument('--auto_temperature', type=float, default=1.0,
                        help='Softmax temperature for feature selection weights in auto mode.')
