...
def main() -> None:
    ...
    # Use AMP during inference if training was done with AMP, to ensure
    # consistent numeric precision (BF16 forward pass).
    use_amp_infer = train_config.get('amp', False)
