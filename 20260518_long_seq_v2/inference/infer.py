...
_FALLBACK_MODEL_CFG = {
    ...
    'num_heads': 4,
    'seq_encoder_type': ['transformer', 'longer', 'longer', 'longer'],
    'hidden_mult': 4,
    'dropout_rate': 0.01,
    'seq_top_k': 512,
    'seq_causal': False,
    ...
    'item_ns_tokens': 2,
    'user_dense_ue_fids': '',
    'user_int_dense_pair_fids': '',
}

_FALLBACK_SEQ_MAX_LENS = 'seq_a:256,seq_b:1024,seq_c:1024,seq_d:2048'
# seq_domains order (sorted alphabetically): seq_a, seq_b, seq_c, seq_d
# per-domain encoder: seq_a=transformer, seq_b/c/d=longer
