...
class PCVRParquetDataset(IterableDataset):
    ...
    def __init__(
        ...
        for domain in self.seq_domains:
            ...
            # sideinfo_fids already includes the 2 synthetic hour/day_of_week slots
    ...
    def _convert_batch(self, batch: "pa.RecordBatch") -> Dict[str, Any]:
        ...
        for domain in self.seq_domains:
            ...
            if ts_ci is not None:
                ...
                hour_slot = len(side_plan)       # last real slot index
                dow_slot = len(side_plan) + 1     # one past last
