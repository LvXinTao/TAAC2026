...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--time_split_map', type=str, default=None,
                        help='Path to time_split_map.json for time-ordered '
                             'train/val split (overrides row-group-order split)')
...
def main() -> None:
    ...
    train_loader, valid_loader, pcvr_dataset = get_pcvr_data(
        ...
        time_split_map_path=args.time_split_map,
    )
