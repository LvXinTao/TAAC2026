...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--max_lr_steps', type=int, default=0,
                        help='Total number of steps for cosine LR annealing after warmup '
                             '(0 = no decay, lr stays at full value after warmup). '
                             'Set to approximate total training steps for lr → 0 decay.')
...
def main() -> None:
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        max_lr_steps=args.max_lr_steps,
