...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--token_specific_q', action='store_true', default=False,
                        help='Use token-specific Q projections in cross-attention '
                             '(each global token gets its own Q matrix)')
...
def main() -> None:
    ...
    model_args = {
        ...
        "token_specific_q": args.token_specific_q,
    }
