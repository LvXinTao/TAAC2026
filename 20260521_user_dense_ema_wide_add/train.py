...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_wide_branch', action='store_true', default=False,
                        help='Enable wide&deep additive fusion: ns_tokens -> linear '
                             'branch added to HyFormer output before classifier.')
...
def main() -> None:
    ...
    model_args = {
        ...
        "use_wide_branch": args.use_wide_branch,
    }
