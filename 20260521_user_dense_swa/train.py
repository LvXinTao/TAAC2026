...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--swa_start', type=int, default=0,
                        help='Number of steps before SWA averaging begins (0 = use warmup_steps).')
    parser.add_argument('--swa_freq', type=int, default=0,
                        help='Update SWA weights every N steps after swa_start (0 = disabled). '
